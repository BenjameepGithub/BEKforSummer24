...
// Fetched from IL3DN - Stylized 
    public class CharacterMovement : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            if (m_Camera != null) m_MouseLook.Init(transform, m_Camera.transform);
        }
        ...
        private void FixedUpdate()
        {
            ...
            Vector3 desiredMove = transform1.forward * m_Input.y + transform1.right * m_Input.x;

            // get a normal for the surface that is being touched to move along it
            RaycastHit hitInfo;
            Physics.SphereCast(transform1.position, m_CharacterController.radius, Vector3.down, out hitInfo,
        ...
        {
            ChangeSound soundScript = other.GetComponent<ChangeSound>();
            if (soundScript != null)
            {
